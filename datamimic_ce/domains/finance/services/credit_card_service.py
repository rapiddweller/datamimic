...
class CreditCardService:
    ...
    def generate_card_holder(self) -> str:
        ...
        first_names = ["John", "Jane", "Michael", "Emily", "David", "Sarah", "Robert", "Jennifer", 
                      "William", "Elizabeth", "Richard", "Linda", "Joseph", "Patricia", "Thomas", "Barbara"]
    ...
    def generate_credit_card(
        ...
        if bank_name is None:
            ...
            bank_names = ["First National Bank", "City Bank", "Capital One", "Wells Fargo", 
                          "Bank of America", "Chase", "Deutsche Bank", "Commerzbank"]
