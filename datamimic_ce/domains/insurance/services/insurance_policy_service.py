...
class InsurancePolicyService:
    ...
    def generate_policy_holder(self) -> PolicyHolder:
        ...
        return PolicyHolder(
            ...
            email=person_data.get(
                "email",
                f"{person_data.get('firstName', 'John').lower()}.{person_data.get('lastName', 'Doe').lower()}@example.com",
            ),
    ...
    def calculate_premium(
        self, product: InsuranceProduct, coverages: list[PolicyCoverage], policy_holder: PolicyHolder
    ) -> float:
        ...
        age = (
            today.year
            - policy_holder.date_of_birth.year
    ...
    def generate_insurance_policy(
        self,
        company: InsuranceCompany | None = None,
        product: InsuranceProduct | None = None,
        policy_holder: PolicyHolder | None = None,
    ) -> InsurancePolicy:
