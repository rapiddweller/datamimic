...
class AdministrationDataLoader(PublicSectorDataLoader):
    ...
    @classmethod
    def load_agencies(cls, dataset: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    @classmethod
    def _load_agencies_by_weight(cls, dataset: Optional[str] = None) -> List[Tuple[Dict[str, Any], float]]:
    ...
    @classmethod
    def load_positions(cls, dataset: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    @classmethod
    def _load_positions_by_weight(cls, dataset: Optional[str] = None) -> List[Tuple[Dict[str, Any], float]]:
