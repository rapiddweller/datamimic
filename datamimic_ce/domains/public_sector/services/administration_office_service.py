...
class AdministrationOfficeService(Service):
    ...
    def export_offices(
        self, count: int = 100, output_path: str = "administration_offices.json", format: str = "json"
    ) -> str:
    ...
    def get_offices_by_budget_range(
        self, min_budget: float, max_budget: float, count: int = 10
    ) -> list[dict[str, Any]]:
