...
class ProductDataLoader(BaseDataLoader):
    ...
    @classmethod
    def get_product_categories(cls, dataset: str | None = None) -> list[tuple[str, float]]:
    ...
    @classmethod
    def get_product_brands(cls, dataset: str | None = None) -> list[tuple[str, float]]:
    ...
    @classmethod
    def get_product_conditions(cls, dataset: str | None = None) -> list[tuple[str, float]]:
    ...
    @classmethod
    def get_product_availability(cls, dataset: str | None = None) -> list[tuple[str, float]]:
    ...
    @classmethod
    def get_currencies(cls, dataset: str | None = None) -> list[tuple[str, float]]:
    ...
    @classmethod
    def get_product_adjectives(cls, dataset: str | None = None) -> list[tuple[str, float]]:
    ...
    @classmethod
    def get_product_nouns(cls, category: str, dataset: str | None = None) -> list[tuple[str, float]]:
