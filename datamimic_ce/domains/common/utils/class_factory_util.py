...
def get_subclasses(base_class: type[T], include_abstract: bool = False) -> list[type[T]]:
    ...
    for subclass in base_class.__subclasses__():
        ...
        all_subclasses.extend(get_subclasses(subclass, include_abstract))
...
def create_registered_instance(base_class: type[T], name: str, **kwargs: Any) -> T:
    ...
    """
    registered_classes = get_registered_classes(base_class)
    return create_instance_by_name(registered_classes, name, **kwargs)
