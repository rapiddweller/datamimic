            ...
            try:
                ...
                if isinstance(context, SetupContext) and num_workers > 1:
                    ...
                    if mp_platform == "multiprocessing":
                        from datamimic_ce.engine.runtime.workers.multiprocessing_generate_worker import (
                        ...
                        try:
                            ...
                            from datamimic_ce.engine.runtime.workers.ray_generate_worker import RayGenerateWorker
