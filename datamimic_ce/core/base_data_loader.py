...
class BaseDataLoader:
    ...
    def get_country_specific_data(
        ...
        Args:
            ...
            cache_dict: Optional cache dictionary to use

        Returns:
            A list of tuples containing values and weights
        """
        # Use the provided cache dictionary or get the appropriate one for the data type
    ...
    def _get_default_values(cls, data_type: str) -> list[tuple[str, float]]:
        ...
        logger.warning(f"No data files or default values available for {data_type}")
        return []
