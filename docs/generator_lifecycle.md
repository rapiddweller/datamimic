...
- Keep dataset I/O in generators; models must be pure (no file reads, no logging). Resolve paths via `datamimic_ce.domains.shared.utils.dataset_path.dataset_path` or the lightweight loaders.
