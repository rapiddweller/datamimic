...
class TestCPUPostgresqlRead:
    ...
    def class_fixture(self):
        ...
        print("\nCPU Usage Summary for Postgresql Read Data:")
    ...
    def test_single_thread_postgresql_read_100(self, class_fixture) -> None:
        ...
        rounds = 3
        # insert data
        self._insert_postgresql_data("cpu_measure_postgresql_write.xml", count=count, multiprocessing=multiprocessing)
        # execute measure
        time.sleep(1)  # Warm-up period
        xml_path = self._test_dir.joinpath("cpu_measure_postgresql_read.xml")
