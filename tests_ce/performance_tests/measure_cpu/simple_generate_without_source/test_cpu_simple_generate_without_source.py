...
class TestCPUSimpleGenerateWithoutSource:
    ...
    def test_cpu_single_thread_without_source_1000(self, class_fixture):
        count = "1000"
        ...
        xml_path = self._test_dir.joinpath("cpu_measure_simple_generate_without_source.xml")
