...
class TestCPUMongoDBRead:
    ...
    def class_fixture(self):
        ...
        table = PerformanceTestUtil.modify_display_measure_result(header_cell="Avg CPU usage(%)",
                                                                  results=results)
        print("\nCPU Usage Summary for MongoDB Read Data:")
    ...
    def test_single_thread_mongodb_read_100(self, class_fixture) -> None:
        count = "100"
        multiprocessing = "False"
        test_group = "single_thread_mongodb_read"
        test_case = f"test_{count}"
        rounds = 3
        # insert data
        self._insert_mongodb_data("cpu_measure_mongodb_write.xml", count=count, multiprocessing=multiprocessing)
        # execute measure
        time.sleep(1)  # Warm-up period
        xml_path = self._test_dir.joinpath("cpu_measure_mongodb_read.xml")
    ...
    def test_single_thread_mongodb_read_1000(self, class_fixture) -> None:
        count = "1000"
        multiprocessing = "False"
        test_group = "single_thread_mongodb_read"
        test_case = f"test_{count}"
    ...
    def test_single_thread_mongodb_read_10000(self, class_fixture) -> None:
        count = "10000"
        multiprocessing = "False"
        test_group = "single_thread_mongodb_read"
        test_case = f"test_{count}"
    ...
    def test_multiprocessing_mongodb_read_100(self, class_fixture) -> None:
        count = "100"
        multiprocessing = "True"
        test_group = "multiprocessing_mongodb_read"
        test_case = f"test_{count}"
        rounds = 3
        # insert data
        self._insert_mongodb_data("cpu_measure_mongodb_write.xml", count=count, multiprocessing=multiprocessing)
    ...
    def test_multiprocessing_mongodb_read_1000(self, class_fixture) -> None:
        count = "1000"
        multiprocessing = "True"
        test_group = "multiprocessing_mongodb_read"
        test_case = f"test_{count}"
    ...
    def test_multiprocessing_mongodb_read_10000(self, class_fixture) -> None:
        count = "10000"
        multiprocessing = "True"
        test_group = "multiprocessing_mongodb_read"
        test_case = f"test_{count}"
