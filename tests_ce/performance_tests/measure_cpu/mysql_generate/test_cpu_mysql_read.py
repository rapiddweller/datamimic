...
class TestCPUMysqlRead:
    ...
    def test_single_thread_mysql_read_100(self, class_fixture) -> None:
        ...
        rounds = 3
        # insert data
        self._insert_mysql_data("cpu_measure_mysql_write.xml", count=count, multiprocessing=multiprocessing)
        # execute measure
        time.sleep(1)  # Warm-up period
        xml_path = self._test_dir.joinpath("cpu_measure_mysql_read.xml")
