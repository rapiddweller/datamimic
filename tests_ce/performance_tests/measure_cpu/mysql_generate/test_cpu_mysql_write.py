...
class TestCPUMysqlWrite:
    ...
    def class_fixture(self):
        ...
        table = PerformanceTestUtil.modify_display_measure_result(header_cell="Avg CPU usage(%)",
                                                                  results=results)
        print("\nCPU Usage Summary for Mysql Write Data:")
    ...
    def test_single_thread_mysql_write_100(self, class_fixture):
        ...
        xml_path = self._test_dir.joinpath("cpu_measure_mysql_write.xml")
    ...
    def test_single_thread_mysql_write_1000(self, class_fixture):
        count = "1000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_single_thread_mysql_write_10000(self, class_fixture):
        count = "10000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_mysql_write_100(self, class_fixture):
        count = "100"
    ...
    def test_multiprocessing_mysql_write_1000(self, class_fixture):
        count = "1000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_mysql_write_10000(self, class_fixture):
        count = "10000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
