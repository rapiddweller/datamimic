...
class TestTimePostgresqlWrite:
    ...
    def test_single_thread_postgresql_write_200(self, benchmark):
        count = "200"
        ...
        benchmark.group = "single_thread_postgresql_write"
        benchmark.name = f"test_{count}"
        xml_path = self._test_dir.joinpath("measure_postgresql_write.xml")
    ...
    def test_single_thread_postgresql_write_2000(self, benchmark):
        count = "2000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_single_thread_postgresql_write_20000(self, benchmark):
        count = "20000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_postgresql_write_200(self, benchmark):
        count = "200"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)

        benchmark.group = "multiprocessing_postgresql_write"
        benchmark.name = f"test_{count}"
        xml_path = self._test_dir.joinpath("measure_postgresql_write.xml")
        kwargs = {"descriptor_path": xml_path, "task_id": "test"}
    ...
    def test_multiprocessing_postgresql_write_2000(self, benchmark):
        count = "2000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_postgresql_write_20000(self, benchmark):
        count = "20000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
