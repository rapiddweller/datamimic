...
class TestTimeSimpleGenerateWithoutSource:
    ...
    def test_single_thread_without_source_1000(self, benchmark):
        count = "1000"
        ...
        benchmark.group = "single_thread_without_source"
        benchmark.name = f"test_{count}"
        xml_path = self._test_dir.joinpath("measure_big_generate_all_datatypes_without_source.xml")
        kwargs = {"descriptor_path": xml_path, "task_id": "test"}

        time.sleep(1)  # Warm-up period
        benchmark(DataMimic(**kwargs).parse_and_execute)

    def test_single_thread_without_source_10000(self, benchmark):
        count = "10000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_single_thread_without_source_100000(self, benchmark):
        count = "100000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_without_source_1000(self, benchmark):
        count = "1000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)

        benchmark.group = "multiprocessing_without_source"
        benchmark.name = f"test_{count}"
        xml_path = self._test_dir.joinpath("measure_big_generate_all_datatypes_without_source.xml")
        kwargs = {"descriptor_path": xml_path, "task_id": "test"}
    ...
    def test_multiprocessing_without_source_10000(self, benchmark):
        count = "10000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_without_source_100000(self, benchmark):
        count = "100000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
