...
class TestTimeMssqlRead:
    ...
    def test_single_thread_mssql_read_200(self, benchmark):
        count = "200"
        multiprocessing = "False"
        benchmark.group = "single_thread_mssql_read"
        benchmark.name = f"test_{count}"
        # insert data
        self._insert_data("measure_mssql_write.xml", count=count, multiprocessing=multiprocessing)
        # execute benchmark test
        time.sleep(1)  # Warm-up period
        xml_path = self._test_dir.joinpath("measure_mssql_read.xml")
    ...
    def test_single_thread_mssql_read_2000(self, benchmark):
        count = "2000"
        multiprocessing = "False"
        benchmark.group = "single_thread_mssql_read"
        benchmark.name = f"test_{count}"
    ...
    def test_single_thread_mssql_read_20000(self, benchmark):
        count = "20000"
        multiprocessing = "False"
        benchmark.group = "single_thread_mssql_read"
        benchmark.name = f"test_{count}"
    ...
    def test_multiprocessing_mssql_read_200(self, benchmark):
        count = "200"
        multiprocessing = "True"
        benchmark.group = "multiprocessing_mssql_read"
        benchmark.name = f"test_{count}"
        # insert data
        self._insert_data("measure_mssql_write.xml", count=count, multiprocessing=multiprocessing)
        # execute benchmark test
    ...
    def test_multiprocessing_mssql_read_2000(self, benchmark):
        count = "2000"
        multiprocessing = "True"
        benchmark.group = "multiprocessing_mssql_read"
        benchmark.name = f"test_{count}"
    ...
    def test_multiprocessing_mssql_read_20000(self, benchmark):
        count = "20000"
        multiprocessing = "True"
        benchmark.group = "multiprocessing_mssql_read"
        benchmark.name = f"test_{count}"
