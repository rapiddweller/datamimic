...
class TestRAMSimpleGenerateWithSource:
    ...
    def class_fixture(self):
        ...
        print("\nRAM Usage Summary for Simple Generation with Source:")
        print(table)
    ...
    def test_ram_single_thread_with_source_1000(self, class_fixture):
        count = "1000"
        ...
        xml_path = self._test_dir.joinpath("ram_measure_simple_generate_with_source.xml")
