...
class TestRAMMssqlWrite:
    ...
    def class_fixture(self):
        ...
        print("\nRAM Usage Summary for Mssql Write Data:")
        print(table)
    ...
    def test_single_thread_mssql_write_100(self, class_fixture):
        count = "100"
        ...
        test_group = "single_thread_mssql_write"
        test_case = f"test_{count}"
        rounds = 2

        xml_path = self._test_dir.joinpath("ram_measure_mssql_write.xml")
    ...
    def test_single_thread_mssql_write_1000(self, class_fixture) -> None:
        count = "1000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_single_thread_mssql_write_10000(self, class_fixture) -> None:
        count = "10000"
        multiprocessing = "False"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_mssql_write_100(self, class_fixture) -> None:
        count = "100"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)

        test_group = "multiprocessing_mssql_write"
        test_case = f"test_{count}"
        rounds = 2
    ...
    def test_multiprocessing_mssql_write_1000(self, class_fixture) -> None:
        count = "1000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
    ...
    def test_multiprocessing_mssql_write_10000(self, class_fixture) -> None:
        count = "10000"
        multiprocessing = "True"
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "count", count)
        PerformanceTestUtil.modify_value_in_properties(self._base_path, "multiprocessing", multiprocessing)
