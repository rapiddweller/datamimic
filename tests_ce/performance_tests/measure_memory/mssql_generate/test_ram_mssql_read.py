...
class TestRAMMssqlRead:
    ...
    def class_fixture(self):
        ...
        table = PerformanceTestUtil.modify_display_measure_result(header_cell="Avg RAM usage",
                                                                  results=results)
        print("\nRAM Usage Summary for Mssql Read Data:")
        print(table)
    ...
    def test_single_thread_mssql_read_100(self, class_fixture) -> None:
        ...
        rounds = 2
        # insert data
        self._insert_mssql_data("ram_measure_mssql_write.xml", count=count, multiprocessing=multiprocessing)
        # execute measure
        time.sleep(1)  # Warm-up period
        xml_path = self._test_dir.joinpath("ram_measure_mssql_read.xml")
