...
class TestDateTimeGeneratorWeighted:
    def test_hour_weights_night_bias(self):
        ...
        gen = DateTimeGenerator(
            min="2024-01-01 00:00:00", max="2024-01-31 23:59:59", random=True, hour_weights=hour_weights
        )
    ...
    def test_minute_weights(self):
        ...
        gen = DateTimeGenerator(
            min="2024-01-01 00:00:00", max="2024-01-02 00:00:00", random=True, minute_weights=minute_weights
        )
    ...
    def test_second_weights(self):
        ...
        gen = DateTimeGenerator(
            min="2024-01-01 00:00:00", max="2024-01-01 01:00:00", random=True, second_weights=second_weights
        )
    ...
    def test_no_weights_equals_default(self):
        ...
        gen = DateTimeGenerator(min="2024-01-01 00:00:00", max="2024-01-01 01:00:00", random=True)
